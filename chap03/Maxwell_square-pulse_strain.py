...
if __name__=='__main__':
    ...
    ax1.plot(tim0, strain0, c='b', lw=2, label='Pulse strain')
    ax1.plot(tim1, strain1, c='b', lw=2)
    ...
    ax2.plot(tim0, stress0, c='r', lw=2, label='Response to pulse strain')
    ax2.plot(tim1, stress1, c='r', lw=2)
