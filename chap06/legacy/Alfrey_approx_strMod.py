# Alfrey approximation for storage modulus
...
ax.set_ylabel(r'$\omega^2\tau^2 / (1 + \omega^2\tau^2)$')
ax.plot(tau, func)
...
ax.grid()
fig.text(0.18,0.8, r'1/$\omega$ = 10 s')
fig.text(0.24,0.22, r'$\tau < t$')
fig.text(0.35,0.22, r'$t < \tau$')
fig.text(0.15,0.56, '0.5')

fig.savefig('./png/Alfrey_approx_strMod.png')
