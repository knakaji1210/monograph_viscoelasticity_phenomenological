...
#    print(t[0],t[-1],len(t))
    ...
    # ODEの解析
    sol = odeint(SLS2_sinuStrain, s0, t - t_start, args=(eamp,af,insMod,k,tau)) # ODEの解
    stress_f = sol[:, 0]            # 応力履歴
...
ax2 = ax1.twinx()
ax2.grid(ls='dotted')
title_text = "SLS II model: sinusoidal strain (frequecy sweep)"
...
if axisoption == "-log":
    savefile = "./png/SLS2_sinuStrain_dynamicModuli(log)_(tau={0:.1f}s).png".format(tau)
else:
    savefile = "./png/SLS2_sinuStrain_dynamicModuli(linear)_(tau={0:.1f}s).png".format(tau)
