...
ax1.set_title("Voigt model: sinusoidal stress")
ax1.grid(True, ls='--')
...
# テキスト描画
var_text = r'$\sigma_0$ = {0:.2f} MPa, $f$ = {1:.3f} Hz, $E$ = {2:.1f} MPa, $\eta$ = {3:.1f} kPa s'.format(samp/10**6,freq,E/10**6,eta/10**3)
...
savefile = './mp4/Voigt_sinuStress_(f={0:.2f}Hz).mp4'.format(freq)
